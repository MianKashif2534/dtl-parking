    ...
    >
      <header className="lg:px-12 relative h-full">
        <nav className="flex h-full w-full items-center justify-between">
          <Link href="/" className="flex items-center space-x-2">
            <Image className="h-12 w-auto" src="/logo.png" alt="DTL Parkings" width={500} height={500} />
          </Link>
      ...
      >
        <div className="flex items-center justify-between p-4">
          <Link href="/" className="flex items-center space-x-2">
            <Image className="h-8 w-auto" src="/logo.png" alt="DTL Parkings" width={500} height={500} />
          </Link>
          <button
            onClick={toggleMobileMenu}
              ...
              {item.hasDropdown ? (
                <>
                  ...
                  >
                    {item.name}
                    <ChevronDown
                      className={cn("h-4 w-4 transition-transform", isServiceSubmenuOpen ? "rotate-180" : "")}
                    />
                  </button>
                  <div
                    className={cn(
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.href ? "bg-[#A58A47] text-white" : "text-white",
                  )}
                  onClick={toggleMobileMenu}
                >
                  {item.name}
