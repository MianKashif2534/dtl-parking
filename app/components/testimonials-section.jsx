        ...
        >
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center'>
              ...
              <div className='hidden md:flex md:col-span-1'>
                <div className='w-full max-w-[270px] mx-auto relative'>
                  {/* Overlay */}
                  <motion.div
                    className='absolute inset-0 bg-blue w-4/5 h-[120%] left-[10%] transform -translate-x-1/4 -top-[10%] z-0'
              ...
              <div className='md:col-span-2 flex flex-col items-center text-center'>
                ...
                >
                  ...
                  ></motion.div>
                  <motion.h2
                    className='text-white text-2xl md:text-4xl font-bold mx-4 py-2'
                    variants={titleVariants}
                  >
                    Testimonials
                  </motion.h2>
                ...
                <motion.div
                  className='text-royalblue text-4xl md:text-6xl mb-4 w-full'
                ...
                <motion.div
                  className='text-royalblue text-4xl md:text-6xl w-full flex justify-end'
                  variants={quoteVariants}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: 0.3 }}
          ...
          <div className='relative mt-5 bottom-0 md:absolute md:bottom-12 md:right-60 md:left-auto flex gap-4 justify-center md:justify-start w-full md:w-auto'>
            ...
            <motion.button
              ...
              className='w-12 h-12 bg-royalblue hover:bg-blue rounded-full border-2 border-white flex items-center justify-center text-white transition-colors'
            ...
            <motion.button
              ...
              className='w-12 h-12 bg-white border-2 border-royalblue hover:bg-blue rounded-full flex items-center justify-center text-royalblue transition-colors'
