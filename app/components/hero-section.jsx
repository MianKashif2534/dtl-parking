        ...
        <div className="relative w-full h-[600px] md:h-[900px] overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col items-center mt-32 text-white text-center px-4 pt-16">
                ...
                <div className="flex items-center justify-center mb-8 space-x-3">
                    ...
                    <h2 className="font-bold text-4xl leading-[40px] text-center text-[#461094]">Welcome to DTL</h2>
                    <div className="w-48 h-2 bg-[linear-gradient(90deg,_#964FFF_0%,_#5A2F99_100%)] rounded-2xl"></div>
                </div>
                ...
                {/* CTA Button */}
                <Link href="/" className="text-white px-6 py-5 rounded-md shadow-[0_0_4px_#5A2F99] bg-[linear-gradient(90deg,_rgba(46,27,82,0.12)_0%,_rgba(103,61,184,0.72)_100%)]">
                    Request a Quote
                </Link>
            </div>
