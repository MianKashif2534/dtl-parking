        ...
        <div className="min-h-screen">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 md:mb-16">
                    <h1 className="text-white text-2xl md:text-4xl font-bold mb-6 text-center">
                        Reliable Freight Solutions — Coast to Coast
                    </h1>
                    <p className="text-white/80 md:text-lg max-w-4xl mx-auto font-light text-center">
                ...
                <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-8">
                    ...
                    <div className="space-y-6 md:space-y-0 flex flex-col md:row-span-2 font-light">
                        <div className="order-2 mt-6 md:mt-8">
                            <h2 className="text-white text-2xl md:text-3xl font-bold mb-3 md:mb-4">Team Driver Services</h2>
                            ...
                            <ul className="space-y-2 md:space-y-3">
                                {[
                                    ...
                                    <li key={index} className="flex items-start">
                                        <div className="bg-white border-2 border-royalpurple rounded-full w-5 h-5 md:w-6 md:h-6 mt-0.5 flex items-center justify-center mr-2 md:mr-3 flex-shrink-0">
                    ...
                    <div className="space-y-0 flex flex-col md:row-span-2 md:col-start-2 md:row-start-1 font-light">
                        <div className="order-2 mt-6 md:mt-8">
                            <h2 className="text-white text-2xl md:text-3xl font-bold mb-3 md:mb-4">Single Driver Services</h2>
                            <p className="text-white/80 text-sm md:text-base mb-4 md:mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-16 font-light">
                    <div>
                    ...
                    <div>
                        <h2 className="text-white text-2xl md:text-3xl font-bold mb-4">Temperature-Controlled Freight</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 md:mt-16 font-light">
                    ...
                    <div className="md:order-1">
                        <h2 className="text-white text-2xl md:text-3xl font-bold mb-4">Dry Freight Services</h2>
                        <p className="text-white/80 mb-6 text-sm md:text-base">
            ...
            <div className="relative overflow-hidden border-4 border-royalpurple mt-16 font-light">
                <img
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4 md:p-8">
                    <h2 className="text-purple text-2xl md:text-3xl font-bold mb-6">Nationwide Logistics Coverage</h2>
