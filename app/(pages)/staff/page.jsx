        ...
        >
          <motion.div className='md:w-1/2' variants={itemVariants}>
            <motion.h2
              ...
              animate={
                isIntroInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -30 }
              }
          ...
          <motion.div
            ...
            animate={
              isIntroInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }
            }
            transition={{ duration: 0.7, delay: 0.4, ease: 'easeOut' }}
          >
            <motion.p className='text-sm md:text-base lg:text-lg font-light leading-relaxed'>
              At DTL Transport, our team is the driving force behind everything
              we do. From dispatch and inbound logistics to HR, accounting, and
              fleet maintenance — each member plays a vital role in delivering
        ...
        <div className='min-h-screen p-4 md:p-8'>
          <div className='max-w-6xl mx-auto'>
            <motion.h2
              ...
              animate={
                isTeamGridInView ? { opacity: 1, y: 0 } : { opacity: 0, y: -20 }
              }
              transition={{ duration: 0.7, ease: 'easeOut' }}
            >
              Our Leadership Team
